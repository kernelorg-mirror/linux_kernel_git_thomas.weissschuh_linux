...
static ssize_t
label_show(struct device *dev, const struct device_attribute *devattr, char *buf)
{
...
static ssize_t
in_show(struct device *dev, const struct device_attribute *devattr, char *buf)
{
	const struct sensor_device_attribute *attr = to_sensor_dev_attr(devattr);
...
static ssize_t
min_show(struct device *dev, const struct device_attribute *devattr, char *buf)
{
	const struct sensor_device_attribute *attr = to_sensor_dev_attr(devattr);
	struct menf21bmc_hwmon *drv_data = dev_get_drvdata(dev);
...
static ssize_t
max_show(struct device *dev, const struct device_attribute *devattr, char *buf)
{
	const struct sensor_device_attribute *attr = to_sensor_dev_attr(devattr);
	struct menf21bmc_hwmon *drv_data = dev_get_drvdata(dev);
...
static const SENSOR_DEVICE_ATTR_RO(in0_input, in, 0);
static const SENSOR_DEVICE_ATTR_RO(in0_min, min, 0);
static const SENSOR_DEVICE_ATTR_RO(in0_max, max, 0);
static const SENSOR_DEVICE_ATTR_RO(in0_label, label, 0);
static const SENSOR_DEVICE_ATTR_RO(in1_input, in, 1);
static const SENSOR_DEVICE_ATTR_RO(in1_min, min, 1);
static const SENSOR_DEVICE_ATTR_RO(in1_max, max, 1);
static const SENSOR_DEVICE_ATTR_RO(in1_label, label, 1);
static const SENSOR_DEVICE_ATTR_RO(in2_input, in, 2);
static const SENSOR_DEVICE_ATTR_RO(in2_min, min, 2);
static const SENSOR_DEVICE_ATTR_RO(in2_max, max, 2);
static const SENSOR_DEVICE_ATTR_RO(in2_label, label, 2);
static const SENSOR_DEVICE_ATTR_RO(in3_input, in, 3);
static const SENSOR_DEVICE_ATTR_RO(in3_min, min, 3);
static const SENSOR_DEVICE_ATTR_RO(in3_max, max, 3);
static const SENSOR_DEVICE_ATTR_RO(in3_label, label, 3);
static const SENSOR_DEVICE_ATTR_RO(in4_input, in, 4);
static const SENSOR_DEVICE_ATTR_RO(in4_min, min, 4);
static const SENSOR_DEVICE_ATTR_RO(in4_max, max, 4);
static const SENSOR_DEVICE_ATTR_RO(in4_label, label, 4);

static const struct attribute *const menf21bmc_hwmon_attrs[] = {

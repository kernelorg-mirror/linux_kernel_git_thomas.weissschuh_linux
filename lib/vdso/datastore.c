...
void __init vdso_setup_data_pages(void)
{
	...
	/*
	 * Other subsystems use the vDSO datapages before their dynamic allocation.
	 * They get access to statically allocated ones, which are then replaced by the dynamic ones.
	 */
